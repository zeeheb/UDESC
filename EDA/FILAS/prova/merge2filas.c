...
void merge(int n, int *ptVetor, int *ptVetor2, fila *fm);
...
int main(void) {
  int i, tamanho, elementos, tamanho2, elementos2;
  scanf("%d", &tamanho);
  scanf("%d", &elementos);
  int vetor[elementos], vetor2[elementos];
  int *ptVetor = vetor;
  int *ptVetor2 = vetor2;
  ...
  scanf("%d", &tamanho2);
  scanf("%d", &elementos2);
  fila *ptFilaMerge = criaFila(tamanho*2);
  for(i=0;i<elementos2;i++){
    scanf("%d", ptVetor2+i);
  }
  merge(elementos, ptVetor, ptVetor2, ptFilaMerge);
  mostraFila(ptFilaMerge);
