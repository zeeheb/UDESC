...
Definition invNybble (nb : nybble): nybble:=
  match nb with
  |  (bits b1 b2 b3 b4) => bits (inv b1) (inv b2) (inv b3) (inv b4)
  end.

Compute invNybble (bits B1 B1 B1 B1).

Theorem invInvolutive : forall b, inv(inv b) = b.
...
Theorem invNybbleInvolutive : forall nb, invNybble(invNybble nb) = nb.
Proof. intros nb. destruct nb. simpl. rewrite invInvolutive. rewrite invInvolutive. rewrite invInvolutive. rewrite invInvolutive. reflexivity. Qed.    
